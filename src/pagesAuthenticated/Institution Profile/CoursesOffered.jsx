...
// import { FaGraduationCap, FaSchool, FaFilter, FaDownload, FaEnvelope, FaPhone, FaGlobe } from 'react-icons/fa'
// import { IoMdTime } from 'react-icons/io'
// import { Md10K, MdOutlineCastForEducation, MdOutlineAttachMoney } from 'react-icons/md'
...
//             <h1 className="text-2xl md:text-3xl font-heading font-bold text-navy-blue mb-6">Courses Offered</h1>
...
//                                     <button
//                                         className="w-full text-left flex items-center p-2 hover:bg-background-light transition-colors"
//                                         onClick={() => {
...
//                                     <button
//                                         className="w-full text-left flex items-center p-2 hover:bg-background-light transition-colors rounded cursor-pointer"
//                                         onClick={() => {
...
//                                 </a>
//                                 <button className="flex-1 bg-gold text-black py-3 rounded-md text-center hover:bg-opacity-90 transition-colors">
//                                     Apply Now
//                                 </button>
//                             </div>
//                         </div>
