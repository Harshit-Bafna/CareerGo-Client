            ...
            <div
                ...
                <div
                    ...
                    <div className="p-4 flex items-center border-b">
                        ...
                        <div>
                            <p className="text-sm font-semibold">Priyanshi Jain</p>
                            <p className="text-xs text-gray-600">priyanshij95376@gmail.com</p>
                        </div>
                    </div>
                    <DropdownItem
                        icon={<FaUser/>}
...
const DropdownItem = ({ icon, text, to }) => (
    <NavLink to={to} className="flex items-center p-3 hover:bg-gray-100 cursor-pointer">
        {icon}
