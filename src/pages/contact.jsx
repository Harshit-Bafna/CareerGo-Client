...
const Contact = () => {
    return (
        <section className="relative z-10 overflow-hidden bg-white py-10 md:px-20 sm:px-10 px-0 dark:bg-dark">
            <div className="container">
                <div className="mx-4 flex flex-wrap lg:justify-between">
                    ...
                    <div className="contactForm w-full px-4 lg:w-1/2 ">
                        <div className="relative rounded-lg bg-white mx-3 p-8 mt-2 shadow-lg dark:bg-dark-2 sm:p-12">
                            <form>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="sendBtn w-full rounded border p-2 text-white transition">
                                        Send Message
                                    </button>
                                </div>
                            </form>
